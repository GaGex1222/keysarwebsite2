...
import { CheckCircle, Phone, Award, Clock, Users, MapPin, Server, Network, Cable, Zap } from 'lucide-react';
export default function Page() {
  const features = [{icon:Network,t:"Patch Panel מקצועי",d:"ניהול מסודר של כל כבלי ה-LAN בארון מקצועי עמיד."},{icon:Server,t:"מתגים ונתבים",d:"התקנת מתגים מנוהלים ונתבי WiFi 6 לכיסוי מושלם."},{icon:Cable,t:"כבלי CAT7",d:"הנחת כבלי CAT7 מוגנים לגיגה אמיתי בכל נקודה בבית."}];
  return (
    <div className="bg-slate-50 min-h-screen" dir="rtl">
      <section className="bg-white border-b border-slate-200 py-16 md:py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-900 bg-blue-50 border border-blue-200 rounded-full px-3 py-1.5 mb-6"><Server size={12}/> ארון תקשורת לבית</span>
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight mb-5">ארון תקשורת ביתי<br/><span className="text-blue-900">סדר ויעילות לרשת הביתית</span></h1>
          <p className="text-lg text-slate-500 max-w-2xl leading-relaxed mb-8">ארגון כל כבלי הרשת, הנתב, ה-Patch Panel והמתגים בארון מסודר — רשת מהירה ומסודרת.</p>
      ...
      <section className="py-16 px-4 bg-white border-y border-slate-200"><div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div><p className="text-xs font-semibold text-blue-900 uppercase tracking-widest mb-3">למה לבחור בנו?</p><h2 className="text-2xl font-bold text-slate-900 mb-6">יתרונות ארון תקשורת</h2>
          <ul className="space-y-3"><li key="סדר ו" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>סדר ומסודר — לא בלאגן של כבלים</li><li key="רשת מ" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>רשת מהירה ויציבה לכל חדר</li><li key="קל לת" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>קל לתחזוקה ולשדרוג עתידי</li><li key="אין ה" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>אין השפעה על אסתטיקת הבית</li><li key="הפרדת" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>הפרדת רשתות לפי צורך</li><li key="בסיס " className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>בסיס לבית חכם עתידי</li></ul>
        </div>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-8"><Server size={48} className="text-blue-900 mb-5"/>
          <h3 className="text-xl font-bold text-slate-900 mb-3">תשתית לעשרים שנה</h3>
          <p className="text-slate-500 text-sm leading-relaxed mb-5">ארון תקשורת מסודר הוא הבסיס לכל בית חכם — ותשתית שתשרת אתכם שנים קדימה.</p>
