...
import { CheckCircle, Phone, Award, Clock, Users, MapPin, Building2, Video, Lock } from 'lucide-react';
export default function Page() {
  const features = [{icon:Users,t:"חיבור לכל הדירות",d:"מערכת מרכזית אחת מחברת את כל הדירות בבניין בנוחות."},{icon:Video,t:"וידאו HD בלובי",d:"מצלמה HD בכניסה הראשית לזיהוי מבקרים ברורה."},{icon:Lock,t:"ניהול כניסות",d:"בקרת כניסה חכמה עם רשימת אנשי קשר לכל דירה."}];
  return (
    <div className="bg-slate-50 min-h-screen" dir="rtl">
      <section className="bg-white border-b border-slate-200 py-16 md:py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-900 bg-blue-50 border border-blue-200 rounded-full px-3 py-1.5 mb-6"><Building2 size={12}/> אינטרקום לבניין</span>
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight mb-5">אינטרקום לבניין משותף<br/><span className="text-blue-900">ניהול כניסות לכל הדיירים</span></h1>
          <p className="text-lg text-slate-500 max-w-2xl leading-relaxed mb-8">מערכת אינטרקום מרכזית לבניין — חיבור לכל הדירות, וידאו HD ופתיחת שער/דלת חכמה.</p>
          <div className="flex flex-wrap gap-3">
            ...
            <a href="/" className="border border-slate-300 text-slate-700 px-6 py-3 rounded-lg font-semibold hover:bg-slate-100 transition-colors">מחשבון אינטרקום</a>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white border-y border-slate-200"><div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div><p className="text-xs font-semibold text-blue-900 uppercase tracking-widest mb-3">למה לבחור בנו?</p><h2 className="text-2xl font-bold text-slate-900 mb-6">ניהול בניין חכם</h2>
          <ul className="space-y-3"><li key="חיבור" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>חיבור לכל יחידות הדיור</li><li key="פתיחת" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>פתיחת שער מרכזי לדיירים</li><li key="הודעה" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>הודעה לדייר על מבקר</li><li key="יומן " className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>יומן כניסות ויציאות לועד בית</li><li key="ממשק " className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>ממשק פשוט לכל הגילאים</li><li key="תחזוק" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>תחזוקה קלה ואמינות גבוהה</li></ul>
        </div>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-8"><Building2 size={48} className="text-blue-900 mb-5"/>
          <h3 className="text-xl font-bold text-slate-900 mb-3">פתרון מלא לבניין שלכם</h3>
          <p className="text-slate-500 text-sm leading-relaxed mb-5">מתקינים מערכת אחת שמשרתת את כל הדיירים — עם תמיכה מלאה לאחר ההתקנה.</p>
