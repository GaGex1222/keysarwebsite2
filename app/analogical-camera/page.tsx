      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="relative rounded-[3.5rem] overflow-hidden border border-white/10 bg-[#2a2f3a]/40 shadow-2xl aspect-square md:aspect-video lg:aspect-square flex items-center justify-center">
              {/* מקום לתמונה אחת כפי שביקשת */}
              <img 
                src="/1.jpg" 
                alt="מחירון מתקין 2026" 
                className="w-full h-full object-cover"
              />
              
              <div className="absolute bottom-0 right-0 left-0 p-8 bg-gradient-to-t from-black/80 to-transparent">
                <div className="flex items-center gap-4">
                  <FileText className="text-cyan-500" size={32} />
                  <span className="text-xl font-black italic uppercase tracking-tighter">Price_List_Update</span>
                </div>
              </div>
            </div>
          </motion.div>
