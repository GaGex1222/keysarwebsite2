...
import { CheckCircle, Phone, Award, Clock, Users, MapPin, Wifi, ShieldAlert, Signal, Cable } from 'lucide-react';
export default function Page() {
  const features = [{icon:Cable,t:"חיבור כבלי פיזי",d:"כבל CAT7 מוגן דרך צנרת הבניין — היחיד שעובד דרך בטון."},{icon:Signal,t:"גיגה מלא בממ״ד",d:"מהירות אינטרנט מלאה בתוך הממ״ד — לעבודה, שידורים ושיחות וידאו."},{icon:ShieldAlert,t:"מוכנות לחירום",d:"גישה לעדכוני פיקוד העורף ותקשורת עם הקרובים כשזה חשוב ביותר."}];
  return (
    <div className="bg-slate-50 min-h-screen" dir="rtl">
      <section className="bg-white border-b border-slate-200 py-16 md:py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-900 bg-blue-50 border border-blue-200 rounded-full px-3 py-1.5 mb-6"><ShieldAlert size={12}/> אינטרנט במקלט</span>
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight mb-5">אינטרנט יציב בממ״ד ובמקלט<br/><span className="text-blue-900">תקשורת רציפה בשגרה ובחירום</span></h1>
          <p className="text-lg text-slate-500 max-w-2xl leading-relaxed mb-8">פתרון כבלי מקצועי לחדירת אינטרנט לממ״ד — גיגה אמיתי דרך קירות הבטון, לכל עת.</p>
      ...
      <section className="py-16 px-4 bg-white border-y border-slate-200"><div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div><p className="text-xs font-semibold text-blue-900 uppercase tracking-widest mb-3">למה לבחור בנו?</p><h2 className="text-2xl font-bold text-slate-900 mb-6">למה לחבר אינטרנט לממ״ד?</h2>
          <ul className="space-y-3"><li key="עדכונ" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>עדכוני פיקוד העורף בזמן אמת</li><li key="שיחות" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>שיחות וידאו עם הקרובים</li><li key="שידור" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>שידורי חדשות חיים</li><li key="עבודה" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>עבודה מהמקלט ללא הפרעה</li><li key="שליטה" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>שליטה במצלמות ביתיות מבפנים</li><li key="רשת ג" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>רשת גיבוי לכל מצב חירום</li></ul>
        </div>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-8"><ShieldAlert size={48} className="text-blue-900 mb-5"/>
          <h3 className="text-xl font-bold text-slate-900 mb-3">לא מסתמכים על WiFi בבטון</h3>
          <p className="text-slate-500 text-sm leading-relaxed mb-5">WiFi רגיל לא חודר דרך קירות ממ״ד. הפתרון היחיד הוא כבל פיזי — ואנחנו עושים את זה נכון.</p>
