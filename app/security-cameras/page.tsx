...
import { CheckCircle, Phone, Award, Clock, Users, MapPin, Camera, Shield, Network, Monitor } from 'lucide-react';
export default function Page() {
  const features = [{icon:Shield,t:"אבטחה מובטחת",d:"מצלמות שהרתעה שלהן מוכחת — מפחיתות פריצות ב-60%."},{icon:Network,t:"מגוון חיבורים",d:"חוטי, אלחוטי, IP ואנלוגי — לכל תשתית קיימת."},{icon:Monitor,t:"ניטור מרוחק",d:"צפייה בכל המצלמות מכל מקום דרך האפליקציה."}];
  return (
    <div className="bg-slate-50 min-h-screen" dir="rtl">
      <section className="bg-white border-b border-slate-200 py-16 md:py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-900 bg-blue-50 border border-blue-200 rounded-full px-3 py-1.5 mb-6"><Camera size={12}/> מצלמות אבטחה</span>
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight mb-5">מצלמות אבטחה לכל צורך<br/><span className="text-blue-900">פתרון מקצועי לבית ולעסק</span></h1>
          <p className="text-lg text-slate-500 max-w-2xl leading-relaxed mb-8">מגוון מלא של מצלמות אבטחה — אנלוגיות, IP, WiFi ו-4K — לכל סוג נכס ותקציב.</p>
      ...
      <section className="py-16 px-4 bg-white border-y border-slate-200"><div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div><p className="text-xs font-semibold text-blue-900 uppercase tracking-widest mb-3">למה לבחור בנו?</p><h2 className="text-2xl font-bold text-slate-900 mb-6">הפתרון המושלם לכם</h2>
          <ul className="space-y-3"><li key="מבחר " className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>מבחר מצלמות לכל תקציב</li><li key="התקנה" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>התקנה מקצועית ומהירה</li><li key="ייעוץ" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>ייעוץ חינם לפני הרכישה</li><li key="אחריו" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>אחריות מלאה על הציוד</li><li key="שירות" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>שירות ותמיכה לאחר ההתקנה</li><li key="שדרוג" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>שדרוג עתידי קל ופשוט</li></ul>
        </div>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-8"><Camera size={48} className="text-blue-900 mb-5"/>
          <h3 className="text-xl font-bold text-slate-900 mb-3">מומחים למצלמות אבטחה</h3>
          <p className="text-slate-500 text-sm leading-relaxed mb-5">עם 15 שנות ניסיון ואלפי התקנות — אנחנו יודעים בדיוק מה עובד ומה נכון לנכס שלכם.</p>
