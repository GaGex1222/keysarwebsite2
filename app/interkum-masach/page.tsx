...
import { CheckCircle, Phone, Award, Clock, Users, MapPin, Monitor, Video, Eye, Smartphone } from 'lucide-react';
export default function Page() {
  const features = [{icon:Monitor,t:"מסך HD צבעוני",d:"מסך IPS 7 אינץ בצבע מלא לראייה ברורה גם בלילה."},{icon:Video,t:"הקלטה אוטומטית",d:"שמירת כל המבקרים עם תמונה ושעה — גם כשאתם לא בבית."},{icon:Smartphone,t:"חיבור לנייד",d:"קבלת שיחות ופתיחת הדלת מהמובייל גם מחוץ לבית."}];
  return (
    <div className="bg-slate-50 min-h-screen" dir="rtl">
      <section className="bg-white border-b border-slate-200 py-16 md:py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-900 bg-blue-50 border border-blue-200 rounded-full px-3 py-1.5 mb-6"><Monitor size={12}/> אינטרקום עם מסך</span>
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight mb-5">אינטרקום וידאו עם מסך<br/><span className="text-blue-900">ראו ושמעו הכל בבהירות</span></h1>
          <p className="text-lg text-slate-500 max-w-2xl leading-relaxed mb-8">אינטרקום עם מסך צבעוני HD — ראיית מבקרים ברורה, הקלטה אוטומטית ושליטה נוחה.</p>
      ...
      <section className="py-16 px-4 bg-white border-y border-slate-200"><div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div><p className="text-xs font-semibold text-blue-900 uppercase tracking-widest mb-3">למה לבחור בנו?</p><h2 className="text-2xl font-bold text-slate-900 mb-6">חוויית משתמש מובילה</h2>
          <ul className="space-y-3"><li key="מסך H" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>מסך HD 7 אינץ ברור</li><li key="שמיעה" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>שמיעה וראייה מושלמת</li><li key="הקלטת" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>הקלטת כל המבקרים</li><li key="שיחה " className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>שיחה ממובייל מכל מקום</li><li key="פתיחת" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>פתיחת דלת מרחוק</li><li key="ממשק " className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>ממשק עברי נוח לכולם</li></ul>
        </div>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-8"><Monitor size={48} className="text-blue-900 mb-5"/>
          <h3 className="text-xl font-bold text-slate-900 mb-3">ראיית מבקרים ברורה</h3>
          <p className="text-slate-500 text-sm leading-relaxed mb-5">המסך הצבעוני שלנו מאפשר לזהות מבקרים בבירור — גם בתנאי תאורה קשים.</p>
