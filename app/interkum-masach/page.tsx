    ...
    <div className="min-h-screen bg-sky-50 text-slate-900 font-sans selection:bg-sky-200/30 overflow-hidden" dir="rtl">
      ...
      <header className="relative pt-32 pb-20 px-6 z-10 text-center">
        <motion.div 
          ...
          className="flex items-center justify-center gap-2 mb-6 text-sky-600 font-bold italic tracking-[0.2em] text-xs uppercase"
        >
          <Video size={16} />
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 space-y-40 pb-40">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-10">
            <h2 className="text-4xl md:text-6xl font-black italic uppercase leading-tight">
              היתרונות שרואים <br /><span className="text-sky-600 underline decoration-1 underline-offset-8">מיד.</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                <motion.div 
                  ...
                  className="p-6 border border-sky-100 rounded-3xl bg-white/[0.02] flex flex-col gap-4"
                >
                  <div className="text-sky-600">{item.icon}</div>
                  <h4 className="font-bold text-lg italic text-slate-900">{item.t}</h4>
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-sky-100 blur-[100px] opacity-20" />
            <div className="relative aspect-video rounded-[2rem] border-4 border-slate-800 bg-slate-900 overflow-hidden shadow-2xl">
              ...
              <div className="absolute top-6 right-6 flex items-center gap-2">
                ...
                <span className="text-[10px] font-mono tracking-widest text-slate-900/50 uppercase">Live_Feed_01</span>
              </div>
              <div className="absolute inset-0 flex items-center justify-center">
                <ScanFace size={80} className="text-sky-600/40" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-20">
          <div className="text-center">
            <h2 className="text-4xl md:text-7xl font-black italic uppercase">בית או משרד? <br /><span className="text-sky-600 underline decoration-1 underline-offset-[12px]">ההבדל הוא בצרכים.</span></h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Office */}
            <div className="group p-12 border border-sky-100 rounded-[4rem] bg-white/[0.01] hover:bg-white/[0.03] transition-all">
              <Briefcase className="text-sky-600 mb-8 w-12 h-12" />
            ...
            {/* Home */}
            <div className="group p-12 border border-sky-500/10 rounded-[4rem] bg-cyan-500/[0.02] hover:bg-sky-500/[0.04] transition-all">
              <Home className="text-sky-600 mb-8 w-12 h-12" />
        ...
        <section className="relative py-24 text-center space-y-12 bg-white/[0.01] border-y border-sky-100">
          <div className="max-w-4xl mx-auto space-y-6">
            <h2 className="text-4xl md:text-6xl font-black italic uppercase">הביטחון האישי <br /><span className="text-sky-600">בכל מקום.</span></h2>
            <p className="text-slate-600 text-xl italic leading-relaxed font-light">
          ...
          <div className="flex flex-wrap justify-center gap-6">
             {["פאנל ברזל מוגן מים", "מצלמת לילה מובנית", "קודן מואר", "מסך מגע HD"].map((feat, i) => (
               <span key={i} className="px-6 py-3 rounded-full border border-sky-200 bg-sky-50 text-xs font-black italic uppercase tracking-widest">
                 {feat}
               </span>
             ))}
          </div>
        ...
        >
          <div className="order-2 lg:order-1 relative group">
             <div className="grid grid-cols-2 gap-4 opacity-40 group-hover:opacity-100 transition-opacity">
                <div className="h-40 rounded-2xl bg-sky-50" />
                <div className="h-40 rounded-2xl bg-sky-100" />
                <div className="h-40 rounded-2xl bg-sky-100" />
                <div className="h-40 rounded-2xl bg-sky-50" />
             </div>
             <Search className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-sky-600 w-20 h-20" />
          </div>
          
          <div className="order-1 lg:order-2 space-y-8">
            <h2 className="text-4xl md:text-6xl font-black italic leading-tight uppercase">בחירת <br /><span className="text-sky-600 italic">אנשי המקצוע.</span></h2>
            ...
            <div className="flex items-center gap-4 p-6 border border-sky-100 rounded-3xl bg-white/[0.02]">
              ...
              <div>
                <h4 className="font-bold text-xl italic text-slate-900 uppercase">אחריות מלאה</h4>
        ...
        <section className="text-center py-20">
           ...
           >
             מוכנים <span className="text-sky-600 italic uppercase">לראות</span> <br /> את השינוי?
           </motion.h2>
           <button className="group relative px-20 py-8 bg-white text-black font-[1000] italic text-3xl rounded-[2.5rem] shadow-[0_0_20px_rgba(2,132,199,0.3)] transition-all hover:scale-105 active:scale-95">
