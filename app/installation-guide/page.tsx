...
import { CheckCircle, Phone, Award, Clock, Users, MapPin, Wrench, HardHat, ClipboardCheck } from 'lucide-react';
export default function Page() {
  const features = [{icon:ClipboardCheck,t:"ייעוץ וסקר מקום",d:"מגיעים אליכם, מסקרים את הנכס ומגישים הצעה מותאמת אישית."},{icon:Wrench,t:"התקנה מקצועית",d:"טכנאים מוסמכים מתקינים הכל בצורה מסודרת, נקייה ואסתטית."},{icon:ClipboardCheck,t:"בדיקה ומסירה",d:"בדיקה מלאה לפני המסירה ולימוד השימוש במערכת."}];
  return (
    <div className="bg-slate-50 min-h-screen" dir="rtl">
      <section className="bg-white border-b border-slate-200 py-16 md:py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-900 bg-blue-50 border border-blue-200 rounded-full px-3 py-1.5 mb-6"><Wrench size={12}/> שירות התקנה</span>
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight mb-5">שירות התקנה מקצועי<br/><span className="text-blue-900">מהשלב הראשון ועד הסוף</span></h1>
          <p className="text-lg text-slate-500 max-w-2xl leading-relaxed mb-8">ייעוץ, תכנון, התקנה מסודרת ובדיקה מלאה — הצוות שלנו מטפל בהכל כדי שתוכלו ליהנות מהשקט.</p>
      ...
      <section className="py-16 px-4 bg-white border-y border-slate-200"><div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div><p className="text-xs font-semibold text-blue-900 uppercase tracking-widest mb-3">למה לבחור בנו?</p><h2 className="text-2xl font-bold text-slate-900 mb-6">תהליך ההתקנה שלנו</h2>
          <ul className="space-y-3"><li key="ייעוץ" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>ייעוץ וסקר מקום חינם</li><li key="תכנון" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>תכנון פריסה מיטבי</li><li key="התקנה" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>התקנה נקייה ומסודרת</li><li key="קידוח" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>קידוח וחיבורים מוסתרים</li><li key="בדיקת" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>בדיקת כל הציוד לפני מסירה</li><li key="לימוד" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>לימוד שימוש והפעלה</li></ul>
        </div>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-8"><HardHat size={48} className="text-blue-900 mb-5"/>
          <h3 className="text-xl font-bold text-slate-900 mb-3">מקצועיות בכל שלב</h3>
          <p className="text-slate-500 text-sm leading-relaxed mb-5">מהייעוץ הראשוני ועד ההתקנה הסופית — אנחנו מדריכים, מסבירים ומוודאים שהכל עובד מושלם.</p>
