...
import { CheckCircle, Phone, Award, Clock, Users, MapPin, Network, Wrench, Globe, Server } from 'lucide-react';
export default function Page() {
  const features = [{icon:Globe,t:"WiFi 7 ו-Mesh",d:"רשת Mesh מתקדמת לכיסוי מלא ללא נקודות עיוורות."},{icon:Server,t:"ארונות תקשורת",d:"תכנון, ארגון והתקנת ארונות תקשורת לבתים ועסקים."},{icon:Network,t:"LAN ו-CAT7",d:"פריסת כבלי CAT7 לחיבור יציב וגיגה אמיתי בכל נקודה."}];
  return (
    <div className="bg-slate-50 min-h-screen" dir="rtl">
      <section className="bg-white border-b border-slate-200 py-16 md:py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-900 bg-blue-50 border border-blue-200 rounded-full px-3 py-1.5 mb-6"><Network size={12}/> מערכות תקשורת</span>
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight mb-5">טכנאי מערכות תקשורת<br/><span className="text-blue-900">תשתית רשת מקצועית</span></h1>
          <p className="text-lg text-slate-500 max-w-2xl leading-relaxed mb-8">פריסת רשתות WiFi, LAN, ארונות תקשורת וחדרי שרתים — כל תשתיות התקשורת במקום אחד.</p>
      ...
      <section className="py-16 px-4 bg-white border-y border-slate-200"><div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div><p className="text-xs font-semibold text-blue-900 uppercase tracking-widest mb-3">למה לבחור בנו?</p><h2 className="text-2xl font-bold text-slate-900 mb-6">שירות תקשורת מקיף</h2>
          <ul className="space-y-3"><li key="תכנון" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>תכנון הרשת מהיסוד</li><li key="פריסת" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>פריסת WiFi 7 ו-Mesh</li><li key="כבלי " className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>כבלי CAT7 בכל חדר</li><li key="ארון " className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>ארון תקשורת מסודר</li><li key="בדיקת" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>בדיקת מהירות ואיכות</li><li key="תמיכה" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>תמיכה ושדרוג עתידי</li></ul>
        </div>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-8"><Network size={48} className="text-blue-900 mb-5"/>
          <h3 className="text-xl font-bold text-slate-900 mb-3">רשת שעובדת תמיד</h3>
          <p className="text-slate-500 text-sm leading-relaxed mb-5">הצוות שלנו מתכנן, מפרס ומבדק את כל רכיבי הרשת כדי להבטיח ביצועים מיטביים בכל עת.</p>
