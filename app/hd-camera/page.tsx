...
import { CheckCircle, Phone, Award, Clock, Users, MapPin, Camera, Zap, Eye, Monitor } from 'lucide-react';
export default function Page() {
  const features = [{icon:Monitor,t:"Full HD ו-4K",d:"בחרו את הרזולוציה המתאימה לצרכים ולתקציב שלכם."},{icon:Eye,t:"ראיית לילה",d:"IR LEDs מובנים לראיית לילה חדה ברדיוס של עד 40 מטר."},{icon:Zap,t:"זיהוי תנועה",d:"חיישן תנועה חכם שמפעיל הקלטה ושולח התראה רק כשנדרש."}];
  return (
    <div className="bg-slate-50 min-h-screen" dir="rtl">
      <section className="bg-white border-b border-slate-200 py-16 md:py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-900 bg-blue-50 border border-blue-200 rounded-full px-3 py-1.5 mb-6"><Camera size={12}/> מצלמות HD</span>
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight mb-5">מצלמות אבטחה HD<br/><span className="text-blue-900">תמונה ברורה בכל תאורה</span></h1>
          <p className="text-lg text-slate-500 max-w-2xl leading-relaxed mb-8">מצלמות HD בפורמטים מגוונים — Full HD עד 4K, לשימוש פנימי וחיצוני בכל סוגי הנכסים.</p>
      ...
      <section className="py-16 px-4 bg-white border-y border-slate-200"><div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div><p className="text-xs font-semibold text-blue-900 uppercase tracking-widest mb-3">למה לבחור בנו?</p><h2 className="text-2xl font-bold text-slate-900 mb-6">HD לכל שימוש</h2>
          <ul className="space-y-3"><li key="רזולו" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>רזולוציה Full HD עד 4K</li><li key="ראיית" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>ראיית לילה מתקדמת</li><li key="זיהוי" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>זיהוי תנועה חכם</li><li key="חסכון" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>חסכון בנפח אחסון</li><li key="תמיכה" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>תמיכה בכל מותגי DVR</li><li key="מגוון" className="flex items-start gap-3 text-sm text-slate-600"><CheckCircle size={16} className="text-blue-900 mt-0.5 shrink-0"/>מגוון גדלים ועיצובים</li></ul>
        </div>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-8"><Camera size={48} className="text-blue-900 mb-5"/>
          <h3 className="text-xl font-bold text-slate-900 mb-3">בהירות שמשנה הכל</h3>
          <p className="text-slate-500 text-sm leading-relaxed mb-5">מצלמה עם רזולוציה גבוהה מאפשרת לזהות פנים, לוחיות רישוי ופרטים קטנים — הכרחי לכל מערכת אבטחה.</p>
